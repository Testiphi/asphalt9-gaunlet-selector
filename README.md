...
- 🚗 **点亮式车库** – 预置游戏内常见的22辆赛车，点击车名即可点亮/熄灭，直观标记您拥有的车辆。
- 🔁 **无重复推荐算法** – 按照游戏内推荐顺序（支持斜杠“或”关系，如“秋王/sf90”），依次为五张图分配车辆，**已使用的车辆不会再次分配**，更贴近实际选车场景。
...
👉 [https://testiphi.github.io/asphalt9-gaunlet-selector/](https://testiphi.github.io/asphalt9-gaunlet-selector/)
